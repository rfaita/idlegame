...
public class HealBattleTests {
    ...
    public void basicHealTest1() throws Exception {
        ...
        Assert.assertEquals("h1 heal on turn 2", h1, b.getBattleLog().get(3).getHeroOrigin().getHero());
        Assert.assertEquals("h1 target himself to heal on turn 2", h1, b.getBattleLog().get(3).getHeroesTarget().get(0).getHero());
        Assert.assertEquals("50 heal on turn 2", new Integer(50), b.getBattleLog().get(3).getBattleEvent().getValue());
        ...
        Assert.assertEquals("h2 heal on turn 2", h2, b.getBattleLog().get(4).getHeroOrigin().getHero());
        Assert.assertEquals("h2 target himself to heal on turn 2", h2, b.getBattleLog().get(4).getHeroesTarget().get(0).getHero());
        ...
        Assert.assertEquals("life expected 200", new Integer(150), b.getBattleLog().get(4).getHeroesTarget().get(0).getHero().getCurrentHp());
