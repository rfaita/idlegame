...
public class HealBattleTests {
    ...
    public void basicHealTestWithBuff() throws Exception {
        ...
        Assert.assertEquals("h1 heal with buff on turn 3", h1, b.getBattleLog().get(3).getHeroOrigin().getHero());
        Assert.assertEquals("h1 target himself to heal with buff  on turn 3", h1, b.getBattleLog().get(3).getHeroesTarget().get(0).getHero());
        ...
        Assert.assertEquals("h2 heal with buff on turn 3", h2, b.getBattleLog().get(4).getHeroOrigin().getHero());
        Assert.assertEquals("h2 target himself to heal with buff  on turn 3", h2, b.getBattleLog().get(4).getHeroesTarget().get(0).getHero());
        ...
        Assert.assertEquals("h1 heal with buff on turn 4", h1, b.getBattleLog().get(7).getHeroOrigin().getHero());
        Assert.assertEquals("h1 target himself to heal with buff  on turn 4", h1, b.getBattleLog().get(7).getHeroesTarget().get(0).getHero());
        ...
        Assert.assertEquals("h2 heal with buff on turn 4", h2, b.getBattleLog().get(9).getHeroOrigin().getHero());
        Assert.assertEquals("h2 target himself to heal with buff  on turn 4", h2, b.getBattleLog().get(9).getHeroesTarget().get(0).getHero());
        ...
        Assert.assertEquals("h1 heal with buff on turn 5", h1, b.getBattleLog().get(13).getHeroOrigin().getHero());
        Assert.assertEquals("h1 target himself to heal with buff  on turn 4", h1, b.getBattleLog().get(13).getHeroesTarget().get(0).getHero());
        ...
        Assert.assertEquals("h1 buff done", ActionType.BUFF_DONE, b.getBattleLog().get(14).getBattleEvent().getType());
        
        Assert.assertEquals("h2 heal with buff on turn 5", h2, b.getBattleLog().get(17).getHeroOrigin().getHero());
        Assert.assertEquals("h2 target himself to heal with buff  on turn 4", h2, b.getBattleLog().get(17).getHeroesTarget().get(0).getHero());
        ...
        Assert.assertEquals("h2 buff done", ActionType.BUFF_DONE, b.getBattleLog().get(18).getBattleEvent().getType());
