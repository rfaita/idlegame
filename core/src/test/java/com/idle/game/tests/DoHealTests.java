...
public class DoHealTests {
    ...
    public void testBasicDmg() {
        ...
        BattlePositionedHero tPositionedHero = createBasicAttackPositionedHero(FormationPosition.F_0, createBasicBluntNoCritNoDodge100HpHero());

        b.doHeal(be, aPositionedHero, ae, tPositionedHero, Boolean.FALSE);
    ...
    public void testBasicSpecialDmg() {
        ...
        b.doHeal(be, aPositionedHero, ae, tPositionedHero, Boolean.TRUE);
